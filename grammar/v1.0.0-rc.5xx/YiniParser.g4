 ...
 */
directive
  : YINI_TOKEN yini_mode? eol
  | INCLUDE_TOKEN string_literal? eol
  ;

/*
 * The grammar accepts a KEY here to avoid reserving "strict" and "lenient"
 * globally. The host parser must validate that the value is either
 * "strict" or "lenient", case-insensitively.
 */
yini_mode
  : KEY
  ;
