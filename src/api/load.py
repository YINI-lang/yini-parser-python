...
def loads(text: str, strict=False) -> dict[str, Any]:
    """
...
def load(path: str, strict=False) -> dict[str, Any]:
    """
...
def _parse_input_stream(input_stream: InputStream | FileStream) -> dict[str, Any]:
